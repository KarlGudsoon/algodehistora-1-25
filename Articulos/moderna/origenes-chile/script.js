...
botonGeo.addEventListener("click", function () {
  ...
  texto.innerHTML =
    "El territorio de Chile se formó hace millones de años debido a procesos geológicos como el choque de placas tectónicas, que formaron la cordillera de los Andes, que junto a la corriente de Humboldt, mantiene el Desierto de Atacama.";
  img.src =
    "/img/moderna/descubrimiento-chile/00909c64-2d8e-464b-bcb6-e1013e2b5e7d (2).webp";
...
botonPueblos.addEventListener("click", function () {
  ...
  texto.innerHTML =
    "Antes de la llegada de los españoles y la dominación Inca, en el territorio actual de Chile habitaron diversos pueblos originarios. Como los límites actuales no existían en el siglo XVI, los pueblos tenían su territorio más allá de la frontera actual entre países.";
  img.src =
    "/img/moderna/descubrimiento-chile/selknam-ropa-cazar-removebg-preview.png";
...
document
  .getElementById("boton-parlamento")
  .addEventListener("click", function () {
    const capsula2 = document.querySelector(
