...
document.getElementById("otan").addEventListener("click", function() {
    var paises = document.querySelectorAll(".otan");

    paises.forEach(function(pais) {
        if (pais.classList.contains("active")) {
...
document.getElementById("aliados-usa").addEventListener("click", function() {
    var paises = document.querySelectorAll(".aliados-usa");
...
document.getElementById("pactodevarsovia").addEventListener("click", function() {
    var paises = document.querySelectorAll(".varsovia");
...
document.getElementById("aliados-urss").addEventListener("click", function() {
    var paises = document.querySelectorAll(".aliados-urss");
